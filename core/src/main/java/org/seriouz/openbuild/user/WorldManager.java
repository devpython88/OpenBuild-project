...
public class WorldManager {
    ...
    public void saveAs(String name, WorldSaveParameterBuilder builder) {
        ...
        jSONObject.put("Skin Id", (Object)this.player.skinPath);
        jSONObject.put("X", this.player.x);
        jSONObject.put("Y", this.player.y);
        jSONObject.put("Torch lit", builder.torchLit);
        ...
        try {
            ...
            this.writeJsonToFile("player", name, jSONObject);
    ...
    public float loadFrom(String dirName, BlockParameterBuilder builder, WorldSaveParameterBuilder saveParameterBuilder) {
        ...
        for (i = 0; i < blocksJson.length(); ++i) {
            ...
            this.blockManager.createBlock(x, y, this.blockManager.getBlockPathManager().blockMap.get(id), id, builder);
        }
