...
implements Screen {
    ...
    public MenuScreen(final Game game) {
        ...
        this.playButton.addListener((EventListener)new ClickListener(){

            public void clicked(InputEvent event, float x, float y) {
                game.setScreen((Screen)new GameScreen(MenuScreen.this.skin));
            }
        });
        ...
        this.stage.addActor((Actor)this.playButton);
    ...
    public void render(float v) {
        ScreenUtils.clear((float)0.2f, (float)0.2f, (float)0.2f, (float)1.0f);
        this.batch.begin();
        this.stage.act(v);
        this.stage.draw();
        this.bitmapFont.draw((Batch)this.batch, (CharSequence)"Open Build", this.playButton.getX() - 40.0f, this.playButton.getY() + 100.0f);
        this.batch.end();
    }
